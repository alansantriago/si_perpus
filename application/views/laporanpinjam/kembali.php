...
<div class="container">
	<div class="hk-pg-header">
		<h4 class="hk-pg-title"><span class="pg-title-icon"><i class="fa fa-download"></i></span>Pengembalian Buku</h4>
	</div>
	<div class="row">
		<div class="col-xl-12">
			<section class="hk-sec-wrapper">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-4 col-sm-12">
						...
						<button data-toggle="modal" data-target="#TableDenda" class="btn btn-success btn-wth-icon btn-rounded text-white icon-right pull-right mt-25"><span class="btn-text">Kembalikan</span> <span class="icon-label"><span class="feather-icon"><i data-feather="arrow-right-circle"></i></span></span></button>
					</div>
				</div>
			</section>
		</div>
...
<div class="modal fade" id="TableDenda" tabindex="-1" role="dialog" aria-labelledby="TableDenda" aria-hidden="true">
