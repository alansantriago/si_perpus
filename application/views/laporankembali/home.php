...
<nav class="hk-breadcrumb" aria-label="breadcrumb">
	<ol class="breadcrumb breadcrumb-light bg-transparent">
		...
		<li class="breadcrumb-item active" aria-current="page">Buku yang dipinjam</li>
	</ol>
</nav>
<div class="container">
	<div class="hk-pg-header">
		<h4 class="hk-pg-title"><span class="pg-title-icon">
				<?php if ($this->session->userdata('level') == 'Petugas') { ?>
					<i class="fa fa-download"></i></span>Buku yang dipinjam</h4>
	<?php } else { ?>
		<i class="fa fa-upload"></i></span>Buku yang dipinjam</h4>
	<?php } ?>
