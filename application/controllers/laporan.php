...
class Laporan extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('laporanpinjam/pinjam_view', $this->data);
	...
	public function kembali()
	{
		...
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('laporankembali/home', $this->data);
		$this->load->view('footer_view', $this->data);
	}
	...
	public function pinjam()
	{
		...
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('laporanpinjam/tambah_view', $this->data);
		$this->load->view('footer_view', $this->data);
	}
	...
	public function detailpinjam()
	{
		...
		if ($this->session->userdata('level') == 'Anggota') {
			...
			if ($count > 0) {
				...
				echo '<script>alert("DETAIL TIDAK DITEMUKAN");window.location="' . base_url('laporan') . '"</script>';
			}
		} else {
		...
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('laporanpinjam/detail', $this->data);
		$this->load->view('footer_view', $this->data);
	}
	...
	public function kembalipinjam()
	{
		...
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('laporanpinjam/kembali', $this->data);
		$this->load->view('footer_view', $this->data);
	}
	...
	public function denda()
	{
		...
		if (!empty($this->input->get('id'))) {
			...
			if ($count > 0) {
				...
				echo '<script>alert("KATEGORI TIDAK DITEMUKAN");window.location="' . base_url('laporan/denda') . '"</script>';
			}
		}
		...
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('laporandenda/denda_view', $this->data);
		$this->load->view('footer_view', $this->data);
	}
	...
	public function dendaproses()
	{
		if(!empty($this->input->post('tambah')))
		{
			...
			redirect(base_url('laporan/denda')); 
		}
					...
					<script>
						$(document).ready(function() {
							$("#delete_buku<?= $no; ?>").click(function(e) {
								$.ajax({
									type: "POST",
									url: "<?php echo base_url('laporan/del_cart'); ?>",
...
<?php
	...
	public function del_cart()
	{
		...
		echo '<script>$("#result_buku").load("' . base_url('laporan/buku_list') . '");</script>';
	}
	...
	public function print(){
		$data['Laporan'] = $this->M_Admin->get_table('tbl_pinjam');
		$this -> load-> view ("print_pinjam", $data);
	}
}