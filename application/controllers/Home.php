...
class Home extends CI_Controller {
	...
	function index1(){
		$data['tbl_buku'] = $this->Buku_model->tampil_data()->result();
	...
	public function profile(){
		...
		$tmp['content']=$this->load->view('profile', $data,TRUE);
		$this->load->view('layout',$tmp);
	...
	public function list_buku(){
		$data['title']='Daftar buku';
			...
			$data['data_buku'] = $this->Buku_model->getAllData("tbl_buku");
			$data['data_kategori'] = $this->Buku_model->getAllData("tbl_kategori");
			$data['data_rak'] = $this->Buku_model->getAllData("tbl_rak");
			$data['model'] = $this->Buku_model;
			/*masukan data kedalam view */
			//$data['js']=$this->load->view('admin/buku/js');
			$tmp['content']=$this->load->view('daftar_buku',$data, TRUE);
			$this->load->view('layout',$tmp);
		}
	...
	public function search(){
		...
		$data['cari']=$this->Buku_model->get_keyword($keyword);
		$data['data_buku'] = $this->Buku_model->getAllData("tbl_buku");
		$data['data_kategori'] = $this->Buku_model->getAllData("tbl_kategori");
		$data['data_rak'] = $this->Buku_model->getAllData("tbl_rak");
		$data['model'] = $this->Buku_model;
