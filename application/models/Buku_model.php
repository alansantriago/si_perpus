...
class Buku_model extends CI_Model
 {
	...
	{
		return $this->db->query('SELECT a.id_buku,a.ISBN,a.judul,b.kategori,c.nama_penerbit,d.nama_pengarang,e.nama_rak,a.thn_terbit,a.stok,a.ket FROM tbl_buku AS a INNER JOIN tbl_kategori AS b ON a.id_kategori=b.id_kategori INNER JOIN tb_penerbit AS c ON a.id_penerbit=c.id_penerbit INNER JOIN tb_pengarang AS d ON a.id_pengarang=d.id_pengarang INNER JOIN tb_rak AS e ON a.no_rak=e.no_rak'.(isset($this->wheree)?$this->wheree:''));
	}
	//query pengambilan semua data
	...
	public function get_keyword($keyword){
		...
		$this->db->like('buku_id', $keyword);
		$this->db->like('isbn', $keyword);
		$this->db->like('title', $keyword);
		$this->db->like('penerbit', $keyword);
		$this->db->like('thn_buku', $keyword);
		$this->db->like('jml', $keyword);
		$this->db->like('id_rak', $keyword);
		$this->db->like('tgl_masuk', $keyword);
